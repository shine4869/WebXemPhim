...
<body>
    <header>  
        ...
        <div class="class_title">
                <h2>Hương mật tựa khói sương</h3>
                <p>Hương Mật Tựa Khói Sương là câu chuyện tình yêu lãng mạn có ngọt ngào, 
                có đau thương và thật sự sâu sắc. Với lối viết logic, hài hước và vô cùng hấp dẫn,
                tác giả Điện Tuyến đã mở ra một cánh cửa cho độc giả đi vào thế giới của thần tiên.
                </p>
